  ...
  <body >
    ...
    <section >
      <div >
        <div class="container">
          <h2 >
            Selamat Datang, Di Penjaminan Mutu  Ayuksrii~
          </h2>
          <div class="row">
            <div class="col-lg-12">
              <div style="margin-top: 20%;">
                ...
                <br>
                <div>
                  <a href="<?php echo base_url('/Perpustakaan/petugas'); ?>">Dosen</a> <br><br>
                  <a href="<?php echo base_url('/Perpustakaan/login'); ?>">Admin</a>
                </div>
              </div>
            </div>
          </div>
