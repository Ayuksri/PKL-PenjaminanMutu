          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="banner_content text-center" style="margin-top: 20%;">
                ...
                <div>
                  <a href="<?php echo base_url('/Perpustakaan/login_admin/'); ?>" class="primary-btn2 mb-3 mb-sm-0">ADMIN</a>
                  <a href="<?php echo base_url('/Perpustakaan/login_dosen/'); ?>" class="primary-btn ml-sm-3 ml-0">DOSEN</a>
=======
          <h2 >
