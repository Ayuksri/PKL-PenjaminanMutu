<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      UBAH RENCANA PEMBELAJARAN
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> HOME</a></li>
        <li class="active">UBAH RENCANA PEMBELAJARAN</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo base_url('c_rencana_pembelajaran/update'); ?>">
              <div class="box-body">
                <input type="hidden" name="id" value="<?php echo $m->id_rencana_pembelajaran;?>">
                ...
                <div class="form-group">
                  ...
                  <select id='nidn' class="form-control" name="nidn">
                    <option value="<?php echo $m->nidn;?>">- <?php echo $m->nidn;?> -</option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="minggu_ke">
                    <option value="<?php echo $m->minggu_ke;?>">- <?php echo $m->minggu_ke;?> -</option>
                ...
                <div class="form-group">
                  ...
                  <textarea rows="4" cols="50" name="kemampuan_akhir" class="form-control" placeholder="Masukkan kemampuan akhir yang diharapkan..." required><?php echo $m->kemampuan_akhir;?></textarea>
                </div>
                <div class="form-group">
                  <label>Bahan Kajian (Materi Ajar)</label>
                  <textarea rows="4" cols="50" name="bahan_kajian" class="form-control" placeholder="Masukkan bahan kajian (materi ajar)..." required><?php echo $m->bahan_kajian;?></textarea>
                </div>
                <div class="form-group">
                  <label>Metode Pembelajaran</label>
                  <textarea rows="4" cols="50" name="metode" class="form-control" placeholder="Masukkan metode pembelajaran..." required><?php echo $m->metode;?></textarea>
                </div>
                <div class="form-group">
                  <label>Waktu</label>
                  <select class="form-control" name="waktu">
                    <option value="<?php echo $m->waktu;?>"><?php echo $m->waktu;?> menit</option>
                ...
                <div class="form-group">
                  ...
                  <textarea rows="4" cols="50" name="pengalaman_belajar" class="form-control" placeholder="Masukkan pengalaman belajar mahasiswa..." required><?php echo $m->pengalaman_belajar;?></textarea>
                </div>
                
                <div class="form-group">
                  <label>Bobot Nilai</label>
                  <select class="form-control" name="bobot_nilai">
                    <option value="<?php echo $m->bobot_nilai;?>">- <?php echo $m->bobot_nilai;?> -</option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="id_kriteria">
                    <option value="<?php echo $m->id_kriteria;?>">- <?php echo $m->id_kriteria;?> -</option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="id_cp">
                    <option value="<?php echo $m->id_cp;?>">- <?php echo $m->id_cp;?> -</option>
                 ...
                 <div class="form-group">
                  ...
                  <select class="form-control" name="id_cpl">
                    <option value="<?php echo $m->id_cpl;?>">- <?php echo $m->id_cpl;?> -</option>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="id_referensi" class="form-control" placeholder="Masukkan ID referensi..." value="<?php echo $m->id_referensi;?>" required>
                </div>
              </div>
              <!-- /.box-body -->
