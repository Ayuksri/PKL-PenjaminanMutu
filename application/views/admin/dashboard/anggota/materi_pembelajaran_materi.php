                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a 
                              data-kode_materi="<?=$item->kode_materi?>"
                              data-nama_materi ="<?=$item->nama_materi?>"
                              data-deskripsi="<?=$item->deskripsi?>"
                              data-deskripsi="<?=$item->tanggal_post?>"
                              class="btn btn-warning btn-xs editmateri" alt="edit Buku" href="<?php echo base_url("Perpustakaan/update/materi/{$item->kode_materi}");?>"><i class="fa fa-pencil"></i>
                        </a>
                        <a href="<?=base_url("/Perpustakaan/hapus/materi/{$item->kode_materi}");?>" onclick="return confirm('Yakin Hapus Materi <?=$item->nama_materi?> ?')" class="btn btn-danger btn-xs" alt="Hapus Kusri"><i class="fa fa-trash"></i>
                        </td>
                    </tr>
                    <?php } ?>
                  </tbody>
