              ...
              <div class="box-body">
                <table id="dataAnggota" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="<?=$item->id_semester;?>" class="tabel">
                      <td><?=$i++;?></td>
                      ...
                      <td><?=$item->semester;?></td>
                      <td>
                        <a class="btn btn-success btn-xs detailbuku" alt="detail Matkul" href="<?php echo base_url("/Perpustakaan/listMahasiswa/{$item->id_matkul}");?>"><i class="fa fa-pencil">Input Nilai</i></a>
                        <!-- <a 
                          data-kode_matkul="<?=$item->kode_matkul?>"
                          data-nama_matkul= "<?=$item->nama_matkul?>"
                          data-kelas = "<?=$item->kelas?>"
                          data-semester = "<?=$item->semester?>"
                          class="btn btn-success btn-xs detailbuku" alt="detail Buku" href="<?php echo base_url('/Perpustakaan/listMateri'); ?>"><i class="fa fa-pencil">Detail</i></a> -->
                        </td>
                        <td>
                        <a class="btn btn-success btn-xs detailbuku" alt="detail Matkul" href="<?php echo base_url("/Perpustakaan/listRekapan/{$item->id_matkul}");?>"><i class="fa fa-pencil">Rekap Nilai</i></a>
                        <!-- <a 
                          data-kode_matkul="<?=$item->kode_matkul?>"
                          data-nama_matkul= "<?=$item->nama_matkul?>"
                          data-kelas = "<?=$item->kelas?>"
