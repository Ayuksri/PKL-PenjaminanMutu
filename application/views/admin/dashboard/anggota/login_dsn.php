                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4 col-md-offset-4">
                            ...
                            <div class="account-wall">
                              ...
                              <form class="form-signin" method="POST" action="<?php echo base_url('login/login_d');?>" enctype="multipart/form-data">
                                <input type="text" class="form-control" placeholder="Masukkan NIDN" name="nidn" required autofocus>
