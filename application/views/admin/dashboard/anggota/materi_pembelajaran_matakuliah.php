                ...
                <table id="dataAnggota" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="tabel <?=$item->id_semester;?>">
                      ...
                      <td><?=$item->semester;?></td>
                      <td>
                        <a class="btn btn-info btn-xs detailbuku" alt="detail Matkul" href="<?php echo base_url("/Perpustakaan/data_template_dosen");?>"><i class="fa fa-archive">Template</i></a>
                        <a class="btn btn-success btn-xs detailbuku" alt="detail Matkul" href="<?php echo base_url("/Perpustakaan/listMateri/{$item->id_matkul}");?>"><i class="fa fa-pencil">Detail</i></a>
                        <!-- <a 
